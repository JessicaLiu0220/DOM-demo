...
//create
var create1 = dom.create("<div id='create1'><span>create封装</span></div>");
console.log(create1);
//after
console.log(dom.after(test, create1));
//before
var create2 = dom.create("<div id='create2'>create2</div>");
dom.before(test, create2);
//append
var node1 = dom.create("<div id='node1'>子元素</div>");
dom.append(test, node1);
//wrap
var node2 = dom.create("<div id='node2'></div>");
dom.wrap(test, node2);
//remove
dom.remove(node1);
//empty
var node3 = window.empty;
...
//# sourceMappingURL=/main.409f7323.map